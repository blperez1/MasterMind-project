(function () {
    ...
    console.log("The goal is to determine the sequence that is generated by using process of elimination." + "\n" +
    "Input your four guesses into the provided text box and assert them against the hidden code " + "\n" +
        "enabling hard mode adds additional colors into the possible sequence " + "\n" +
    "red response means that one of your colors is correct and in the correct spot (no particular order tho) " + "\n" +
    "white response means that one of your colors is correct but in the wrong spot (no particular order as well) " + "\n" +
